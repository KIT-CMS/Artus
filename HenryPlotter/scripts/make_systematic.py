...
data_estimation = Data("data", folder="jecUncNom_tauEsNom", weights= Weights( Constant("1.0", "constant")))
ztt_estimation = Ztt()

#definition of categories
some_category = Category( "some", Cuts(Cut("pt_2>40"), Cut("mjj>100")), "m_vis", nbins=40, xlow=0, xhigh=150)
