...
struct CrystalBall2015{
    ...
    CrystalBall2015(double m_, double s_, double a_, double n_){
	init(m_, s_, a_, n_);
    }
...
class RocRes2015{
	...
	CrystalBall2015  cb[NMAXETA][NMAXTRK]; 
...
class RoccoR2015{
	...
	RoccoR2015(); //temporary, will change 
	RoccoR2015(std::string dirname); //temporary, will change 
	~RoccoR2015();
